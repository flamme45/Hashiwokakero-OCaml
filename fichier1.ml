...
(*Toutes les fonctions trouverIle cherchent les iles voisines a partir d'un point et retourne les iles si il y en a et None sinon
...
(*Methode qui compte le nombre d'iles voisines d'un point*)
...
(*Methode qui trace un pont entre deux points, elle prend en parametre un booleen pour savoir si le pont est double  *)
